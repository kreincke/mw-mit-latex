...
( {\footnotesize Weil wir selbst diese Arbeit von \textit{mycsrf} abgeleitetet haben, fügen wir beispielhaft den Hinweis hinzu: {\itshape Format abgeleitet von \texttt{mind your Scholar Research Framework} \copyright K. Reincke CC BY 3.0 DE \lnka{http://fodina.de/mycsrf} }} ) }
